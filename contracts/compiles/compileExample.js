    ...
    return {
        ...
        sources: {
            'UpgradeabilityProxy.sol': {
                content: fs.readFileSync(path.resolve(__dirname, '../contracts', 'UpgradeabilityProxy.sol'), 'utf8')
            }
        },
        settings: {
...
function getImports(dependency) {
    ...
    switch (dependency) {
        case 'Proxy.sol':
            return {contents: fs.readFileSync(path.resolve(__dirname, '../contracts', 'Proxy.sol'), 'utf8')};
